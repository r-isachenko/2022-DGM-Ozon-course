...
\begin{frame}{Continuous Normalizing Flows}
	...
	\begin{block}{Hutchinson's trace estimator}
		\vspace{-0.3cm}
		\[
		    \text{tr}(A) = \text{tr}\left(A\mathbb{E}_{p(\bepsilon)} \left[ \bepsilon \bepsilon^T \right]\right) = \mathbb{E}_{p(\bepsilon)} \left[ \bepsilon^T A \bepsilon \right]; \quad \mathbb{E} [\bepsilon] = 0; \quad \text{Cov} (\bepsilon) = I.
		\]
		\vspace{-0.5cm}
	\end{block}
...
\begin{frame}{Stochastic differential equation (SDE)}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.3\linewidth]{figs/langevin_dynamic}
	\end{figure}
	\myfootnotewithlink{https://yang-song.github.io/blog/2019/ssm/}{Song Y., Generative Modeling by Estimating Gradients of the Data Distribution, blogpost, 2021} 
	\end{frame}
%=======
