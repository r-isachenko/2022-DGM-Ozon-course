...
\end{frame}
%=======
\begin{frame}{Determinant of Jacobian matrix}
...
\begin{frame}{Flows}
	...
	\begin{block}{What we want}
		\begin{itemize}
			\item Efficient computation of Jacobian matrix $\bJ_f = \frac{\partial f(\bx, \btheta)}{\partial \bx}$;
...
\begin{frame}{Forward KL vs Reverse KL}
	...
	\begin{block}{Reverse KL for flow model}
		...
		\item We need to be able to sample from the density $p(\bz)$ (do not need to evaluate it) and to evaluate(!) $\bpi(\bx)$.
