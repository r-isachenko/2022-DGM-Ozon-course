...
\begin{frame}{Gaussian autoregressive model}
	...
	\begin{block}{Inverse transform}
		...
		\vspace{-0.3cm}
	\end{block}
	We have got an invertibale and differentiable transform (it is an autoregressive flow with base distribution $\bz = \cN(0, 1)$!).
...
\begin{frame}{RealNVP}
	...
	\begin{block}{Jacobian}
		...
		\end{pmatrix} = \prod_{j=1}^{m - d} \exp (c_1(\bx_{1:d}, \btheta)_j).
		\]
