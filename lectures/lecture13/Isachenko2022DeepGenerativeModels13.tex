...
\begin{frame}{Score matching}
	...
	\begin{enumerate}
	    ...
	    \item 
	\end{enumerate}
	\myfootnote{\href{https://yang-song.github.io/blog/2019/ssm/}{Song Y. Generative Modeling by Estimating Gradients of the Data Distribution, blog post, 2021} \\ \href{https://arxiv.org/abs/1905.07088}{Song Y. Sliced Score Matching: A Scalable Approach to Density and Score Estimation, 2019}}
\end{frame}
%=======
\begin{frame}{Score matching}
	\vspace{-0.3cm}
	...
	\end{figure}
	\vspace{-0.4cm}
	\begin{block}{Score function estimation}
		\vspace{-0.3cm}
		\[
			\bbE_{\pi}\Bigr[ \frac{1}{2}\| \bs(\bx, \btheta) \|_2^2 + \text{tr}\bigl(\nabla_{\bx} \bs(\bx, \btheta)\bigr) \Bigr] \rightarrow \min_{\btheta}
		\]
		\vspace{-0.6cm}
	\end{block}
	\begin{block}{Sliced score matching (Hutchinson's trace estimation)}
		\vspace{-0.6cm}
		\[
			\bbE_{\pi}\Bigr[ \text{tr}\bigl(\nabla_{\bx} \bs(\bx, \btheta)\bigr) \Bigr] = \bbE_{\pi} \mathbb{E}_{p(\bepsilon)} \left[ {\color{violet}\bepsilon^T \nabla_{\bx} \bs(\bx, \btheta)} \bepsilon \right]; \quad \mathbb{E} [\bepsilon] = 0; \,\, \text{Cov} (\bepsilon) = I.
		\]
	\end{block}
	\myfootnote{\href{https://yang-song.github.io/blog/2019/ssm/}{Song Y. Generative Modeling by Estimating Gradients of the Data Distribution, blog post, 2021} \\ \href{https://arxiv.org/abs/1905.07088}{Song Y. Sliced Score Matching: A Scalable Approach to Density and Score Estimation, 2019}}
\end{frame}
