...
\begin{frame}{Continuous Normalizing Flows}
	...
	\end{block}
	\begin{itemize}
		\item Discrete-in-time normalizing flows need invertible $f$. It costs $O(d^3)$ to get determinant of the Jacobian.
		\item Continuous-in-time flows require only smoothness of $f$. It costs $O(d^2)$ to get the trace of the Jacobian.
	\end{itemize}
	\vspace{-0.5cm}
